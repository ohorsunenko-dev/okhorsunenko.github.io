...
<section>
    <div class="container">
        <div class="row">
            ...
            <h4>Редактировать категорию "<? echo $category['name']; ?>"</h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Название</p>
                        <input type="text" name="name" placeholder="" value="<? echo $category['name']; ?>">

                        <p>Порядковый номер</p>
                        <input type="text" name="sort_order" placeholder="" value="<? echo $category['sort_order']; ?>">
